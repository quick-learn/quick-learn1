...
<div class="navbar  navbar-inverse">
    <div class="navbar-inner">
        <div class="footerindex">
            <center><img width="25" height="25" src="admin/img/chmsc.png">&nbsp;Quick Learning System Developed,Designed and Programmed by: A.N.Shalom</center>
        </div>
        <!-- modal -->
        <!-- mission -->
        <div id="mission" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Quick Learn Mission</strong></div>
                <p>
        ...
        <div id="vision" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Quick Learn Vision</strong></div>

                <p>Quick Learn: Excellence, Competence, and Educational Leaderhip in Science and Technology.</p>
